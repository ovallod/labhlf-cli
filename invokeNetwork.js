...
var paramConfig = require('./config/parameters.json');
...
fabric_client.initCredentialStores().then(() => {
  ...
  return fabric_client.getUserContext(paramConfig.user, true);
  ...
  // ["OrderShippment","{\"packageID\":\"P1\",\"description\":\"Package for product P001\",\"destination\": \"Montpellier, FRANCE, 34006\"}" ]
	var request = {
		chaincodeId: paramConfig.chaincodeId,
		fcn: paramConfig.transactionName,
		args: [paramConfig.transactionArgs],
		txId: tx_id
  };
